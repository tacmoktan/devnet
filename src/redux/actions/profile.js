...
export const createProfile = (formData, history, isProfileEdited = false) => async dispatch => {
    ...
    try {
        ...
        dispatch(setAlert(isProfileEdited ? 'Profile Updated' : 'Profile Created', 'success'));
